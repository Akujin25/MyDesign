      ...
      <nav class="nav">
        <div class="nav-left">
          <a href="#" class="nav-brand">
            <img src={doraemon} alt="UIVerse Logo" />
          </a>
          ...
          <ul class="nav-menu">
            <li>
              <div class="dropdown-container">
                <a href="#" class="nav-link">
                  Elements
                  <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <div class="dropdown-menu grid">
                  ...
                  <a href="#"><span>My favorites</span>
                    <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="16" height="16">
            ...
            <li>
              <a href="#" class="nav-link">Spotlight</a>
            </li>
          </ul>
        </div>
        ...
        <div class="nav-right">
          <a class="nav-link btn-primary">
            <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
              <path d="M12 19v-7m0 0V5m0 7H5m7 0h7" stroke="#F2F2F2" fill="none" stroke-width="2px"></path>
            </svg>
            Create
          </a>

          <button class="nav-link btn-icon">
            <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
          ...
          <div class="dropdown-container">
            <a href="#" class="nav-link btn-profile">
              ...
              <div class="profile-pic">
                <img src={nobita} alt="Profile Pic" />
              </div>
            </a>

            <div class="dropdown-menu profile-dropdown">
              <a href="#">
                <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
                  <path fill="none" d="M0 0h24v24H0z"></path>
              ...
              <a href="#">
                <svg xmlnsXlink="http://www.w3.org/1999/xlink" width="20" height="16.363636363636363" viewBox="0 0 33 27" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#">
                <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="20" height="20">
          ...
          <div class="menu-icon">
            <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 block" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="24" height="24">
